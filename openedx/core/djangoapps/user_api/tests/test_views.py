...
class RegistrationViewTest(ThirdPartyAuthTestMixin, UserAPITestCase):
    ...
    @with_site_configuration(configuration={"PROFESSION_OPTIONS": ["Software Engineer", "Teacher", "Other"]})
    ...
    @with_site_configuration(configuration={"SPECIALTY_OPTIONS": ["Aerospace", "Early Education", "N/A"]})
